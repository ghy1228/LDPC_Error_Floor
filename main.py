...
filename = "5G_LDPC_R0.50_n_dec640_n512_k256_z32_s257_320"
...
q_bit = 5 #for QMS
systematic = 1 #0: non-systematic, 1: systematic (Only Info bit)
z_value = 32 #802:27, wman: 24
punct_start = 1
punct_end = 2*z_value
short_start = 257
short_end = 320
...
etha_discount = 0.8
etha_discount_step = 10
learn_rate_start = 0.001
learn_rate_discount = 0.9
learn_rate_step = 10
...
init_from_file = 1 #Transfer Weights
init_weight = 1 
init_VN_weight = 1
Max_weight = 2
Min_weight = 0
seed_in = 2
SNR_Matrix = np.array([2.0,2.1,2.2,2.3,2.4,2.5])
